            ...
            {props.loggedIn? 
                <Container fluid className='d-flex flex-column justify-content-center align-items-center'>
                    ...
                    <Container className='d-flex flex-row justify-content-between w-50 '>
                        ...
                        <Link to='/games' className='btn btn-danger bi bi-controller fs-1 p-5 rounded-pill w-100 mx-3 d-flex align-items-center justify-content-center'> Previous games</Link>
                    </Container>
                </Container> : 
                <Container fluid className='d-flex flex-column justify-content-center align-items-center'>
